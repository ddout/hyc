...
public class AppTest {
    ...
    public void shouldAnswerWithTrue() throws InterruptedException {
        ...
        String url = "http://192.168.11.234:8600/ei-access/test";
        ...
        HttpResponseObj res = HttpClientApi.doPost(url, RequestData.buildNewRequest(json).toJSONString(), HttpClientApi.CHARSET_UTF8, new
